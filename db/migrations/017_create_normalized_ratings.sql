...
CREATE TABLE IF NOT EXISTS normalized_ratings (
    ...
    raw_rating NUMERIC(5, 3) NOT NULL,
    boxcox_manager_level_rating NUMERIC(5, 3),
    boxcox_grade_level_rating NUMERIC(5, 3),
    final_normalized_rating NUMERIC(5, 3),
    -- Metadata for transparency and audit
    manager_lambda NUMERIC(5, 3),
    manager_group_size INTEGER,
    manager_min_value NUMERIC(5, 3),
    manager_max_value NUMERIC(5, 3),
    grade_lambda NUMERIC(5, 3),
    grade_group_size INTEGER,
    grade_min_value NUMERIC(5, 3),
    grade_max_value NUMERIC(5, 3),
